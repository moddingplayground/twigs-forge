...
public class TwigsConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> PATCH_TWIG = registerConfiguredFeature("patch_twig", Feature.RANDOM_PATCH, createRandomPatchConfiguration(BlockStateProvider.simple(TwigsBlocks.TWIG.get().defaultBlockState()), 3));
    public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> PATCH_PEBBLE = registerConfiguredFeature("patch_pebble", Feature.RANDOM_PATCH, createRandomPatchConfiguration(BlockStateProvider.simple(TwigsBlocks.PEBBLE.get().defaultBlockState()), 2));
    public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> PATCH_SEA_SHELL = registerConfiguredFeature("patch_sea_shell", Feature.RANDOM_PATCH, createRandomPatchConfiguration(BlockStateProvider.simple(TwigsBlocks.SEA_SHELL.get().defaultBlockState()), 2));
